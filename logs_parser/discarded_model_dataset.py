    ...
    def get_round_info(self, dataset):
        ...
        for k in range(len(dataset)):
            ...
            #       {'tag': 'DORA', 'data': {'hai': 113}}
                ...
                closed_hands, open_hands, open_hands_details = self.call_operations(action_data, closed_hands,
                                                                                    open_hands, taken_call_actions,
                                                                                    open_hands_details)
            ...
            # deal with draw and discard operations
                ...
                # update discarded_hands and four_closed_hands for cur player
                    ...
                    self.record_cur_state(player_id, closed_hands, open_hands, discarded_hands, doras, riichi_bets,
                                          scores, taken_call_actions, open_hands_details)
