...
class Chi:
    def __init__(self, player):
        ...
        self.collector = ExperienceCollector('chi', player.config.buffer[0])
...
class Pon:
    def __init__(self, player):
        ...
        self.collector = ExperienceCollector('pon', player.config.buffer[1])
...
class Kan:
    def __init__(self, player):
        ...
        self.collector = ExperienceCollector('kan', player.config.buffer[2])
...
class Riichi:
    def __init__(self, player):
        ...
        self.collector = ExperienceCollector('riichi', player.config.buffer[3])
...
class Discard:
    def __init__(self, player):
        ...
        self.collector = ExperienceCollector('discard', player.config.buffer[4])
