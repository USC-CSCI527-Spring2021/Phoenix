...
from utils.test_helpers import enemy_called_riichi_helper, find_discard_option, string_to_136_array, string_to_136_tile
...
def test_calculate_our_hand_cost():
    ...
    discard_option = find_discard_option(player, honors="2")
...
def test_dont_open_bad_hand_if_there_are_multiple_threats():
    ...
    enemy_called_riichi_helper(table, 2)
